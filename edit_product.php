...
<html>
	...
	<body>
		<section class="formularze">
			...
			Wybierz numer produktu (ID | Nazwa)<select name="id">
			<?php
				$dbhost = 'localhost';
				$dbuser = 'root';
				$dbpass = '';
			...
			<br>
			<label for="login">Nazwa produktu:</label><input type="textarea" name="nazwa"/><br>
			<label for="login">Opis produktu:</label><input type="textarea" name="opis"/><br>
			<label for="login">Cena produktu</label><input type="number" step="any" name="cena"/><br>
			<label for="login">Dostępność produktu</label><input type="number" name="ile"/><br>
