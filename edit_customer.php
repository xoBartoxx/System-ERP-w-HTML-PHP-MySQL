	...
	<body>
		<section class="formularzeee">
			...
			<form action="edit_customer.php" method="post">
				Wybierz klienta (ID | Login): <select name="id">
				<?php
					$dbhost = 'localhost';
					$dbuser = 'root';
					$dbpass = '';
					...
					<label for="login">Login klienta: </label><input type="textarea" name="login"/><br>
					<label for="reset">Zresetuj hasło</label><input type="checkbox" name="reset" value="Zresetuj hasło"/><br>
					<label for="haslo">Nowe hasło:</label><input type="password" name="haslo" id="pass">
